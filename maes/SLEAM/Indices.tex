...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Texto básico para Documentos grandes
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%---------------------------------------------------------------
%  Índice de cuadros: lista de cuadros o tablas
%  Omitir espacio vertical extra
%---------------------------------------------------------------
{\setlength{\parskip}{0pt}
\listoftables
...
\hline
\end{tabular}
\caption[Declaraciones]{Declaraciones de los distintos partidos políticos tras las elecciones en la República Perdida. Según han manifestado con mucho convencimiento, todos han resultado ganadores.}
...
\caption[Golosinas]{Golosinas Lorem Ipsum en tres colores: rojo, morado, amarillo, naranja y verde, obtenidos con tintes naturales.}
...
\caption{Golosinas Lorem Ipsum. Otra versión, obtenida rotando 45 grados la figura en la orden de inserción. Las cajas se rotan en sentido contrario a las agujas del reloj, tomando como centro de rotación el extremo izquierdo de la \emph{baseline} de la caja.}
...
\caption{Diseño con Lorem Ipsum: una nube de palabras sin sentido extraídas de un texto Lorem Ipsum.}
\label{figure.diseno}
}
\end{figure}
%---------------------------------------------------------------
...
\caption{Nube de letras de los alfabetos inglés y griego, habitualmente utilizadas en Matemáticas. La composición se ha realizado con MATLAB.}
\label{figure.letras}
}
\end{figure}
%---------------------------------------------------------------
...
\caption{Figura obtenida modificando las dimensiones de la Figura~\ref{figure.diseno}, especificando su anchura y su altura en la orden \texttt{\textbackslash includegraphics}.}
