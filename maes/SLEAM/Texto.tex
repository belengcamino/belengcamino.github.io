...
{\filleft\Large\hspace{2ex}\chaptertitlename\ \thechapter\hspace{2ex}}
{1em}
{}
\titleformat{\section}[block]%
{\parskip0pt\vspace*{2ex}\color{MidnightBlue}\large\titlerule\vspace{.5ex}}%
{{\LARGE\color{Maroon}$\pmb{\triangleright}$}\hspace{1ex}\thesection}{1em}{\color{MidnightBlue}}
%---------------------------------------------------------------
...
\begin{figure}[h]
\centering
\includegraphics[width=10cm]{images/imagen1}
...
\begin{figure}[h]
\centering
\includegraphics[width=6cm,angle=45]{images/imagen1}
...
\begin{figure}[h]
\centering
\includegraphics[width=10cm]{images/imagen2}
...
\begin{figure}[h]
\centering
\includegraphics[width=15cm, height=4cm]{images/imagen2}
...
%
\bibitem{aubanel}\textsc{Aubanell, A., Benseny, A. \& Delshams, A.,}
\textit{Útiles básicos de Cálculo Numérico}, Labor, Barcelona, 1993.
%
\bibitem{burden} \textsc{Burden, L.R. \& Faires J.D.,}
\textit{Análisis Numérico}, Grupo Editorial Iberoamérica, México, 1985.
%
\bibitem{Ciarlet1} \textsc{Ciarlet, P.G.,}
...
\textit{Analyse Numérique des Equations Différentielles,} Masson, Paris, 1989.
 %
\bibitem{guzman2}\textsc{Guzmán, M.,}
\textit{Ecuaciones diferenciales ordinarias: teoría de estabilidad y control},
Madrid, Alhambra, 1975.
%
\bibitem{henrici22}\textsc{Henrici, P.,}
\textit{Discrete Variable Methods in Ordinary Differential Equations},
John Wiley and Sons, New York, 1962.
%
 \bibitem{henrici1}\textsc{Henrici, P.,}
\textit{Elementos de análisis numérico}, Trillas, México, 1972.
%
\bibitem{infante2}\textsc{Infante, J.A. \& Rey, J.M.,}
\textit{Métodos Numéricos}, Pirámide, Madrid, 1999.
%
\end{thebibliography}
